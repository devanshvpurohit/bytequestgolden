      ...
      <div className="relative overflow-hidden h-[400px] flex flex-col items-center">
        ...
        >
          <div className="flex flex-col gap-3">
            <h3 className="text-2xl text-hackathon-primary glow-text uppercase">The Code Quest</h3>
            <p className="text-sm text-hackathon-accent uppercase tracking-widest">Dungeon of Binary</p>
            <div className="gradient-underline w-32 mx-auto mt-2 rounded-full" />
          </div>

          <div className="flex flex-col gap-2">
            <p className="text-hackathon-secondary text-[10px] tracking-widest uppercase">Edition</p>
            <p className="text-sm">MONSOON HACKATHON 2026</p>
          </div>

          <div className="flex flex-col gap-2">
            <p className="text-hackathon-secondary text-[10px] tracking-widest uppercase">Duration</p>
            <p className="text-sm text-white">30 HOURS OF CONTINUOUS INNOVATION</p>
          </div>

          <div className="flex flex-col gap-2">
            <p className="text-hackathon-secondary text-[10px] tracking-widest uppercase">Venue</p>
            <p className="text-sm text-white">IARE, HYDERABAD</p>
          </div>

          <div className="flex flex-col gap-2">
            <p className="text-hackathon-secondary text-[10px] tracking-widest uppercase">Prize Pool</p>
            <p className="text-lg text-hackathon-primary font-bold">₹1,20,000</p>
          </div>

          <div className="flex flex-col gap-2">
            <p className="text-hackathon-secondary text-[10px] tracking-widest uppercase">Hosted By</p>
            <p className="text-sm text-white">INSTITUTE OF AERONAUTICAL ENGINEERING</p>
          </div>

          <div className="flex flex-col gap-2">
            <p className="text-hackathon-secondary text-[10px] tracking-widest uppercase">Contact Organizers</p>
            <p className="text-[10px] text-white">DEVANSH: 8074237354</p>
            <p className="text-[10px] text-white">ASHRITH: 93909 39091</p>
          </div>

          <div className="mt-12">
            <p className="text-xs text-hackathon-primary glow-text uppercase">★ QUEST COMPLETE ★</p>
          </div>
        </motion.div>
        ...
        >
          <p className="text-[10px] text-gray-300 leading-relaxed mb-4">
            ...
            <span className="text-hackathon-accent font-bold uppercase">Registration: ₹799 per team</span>
          </p>
  ...
  return (
    <div className="flex flex-col gap-6 py-4">
      <div className="bg-black/40 border-2 border-hackathon-primary/30 p-6 rounded-sm relative overflow-hidden">
        ...
        <h3 className="text-2xl text-hackathon-primary mb-4 glow-text">SYSTEM READY</h3>
        <p className="text-sm text-gray-200 leading-relaxed mb-6">
          The Code Quest: Dungeon of Binary is a 30-hour immersive hackathon hosted at IARE, Hyderabad. 
          Join hundreds of student innovators for an unforgettable retro-themed coding adventure. 
          Competing for a prize pool of <span className="text-hackathon-accent font-bold">₹1,20,000</span>.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          <div className="border-l-2 border-hackathon-secondary pl-3">
            <p className="text-[10px] text-hackathon-secondary uppercase tracking-widest">Date</p>
            <p className="text-sm text-white">July 17-18, 2026</p>
          </div>
          <div className="border-l-2 border-hackathon-accent pl-3">
            <p className="text-[10px] text-hackathon-accent uppercase tracking-widest">Fee</p>
